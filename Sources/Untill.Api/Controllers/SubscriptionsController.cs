...
using DomainSubscriptionType = Untill.Domain.Users.SubscriptionType;
using SubscriptionType = Untill.Contracts.Common.SubscriptionType;

namespace Untill.Api.Controllers;
